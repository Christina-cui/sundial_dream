...
(function ($) {
    ...
    $.fn.combobox = function (_57, _58) {
        ...
        return this.each(function () {
            ...
            if (_5a) {
                ...
                _5a = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _57),
                    data: []
                });
            }
            _42(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _5c.width,
                height: _5c.height,
                originalValue: _5c.originalValue,
                disabled: _5c.disabled,
                readonly: _5c.readonly
            });
    ...
    $.fn.combobox.parseOptions = function (_66) {
        var t = $(_66);
        return $.extend({}, $.fn.combo.parseOptions(_66), $.parser.parseOptions(_66, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        panelEvents: {mouseover: _47, mouseout: _49, click: _4a, scroll: _4f},
        ...
        loader: function (_7a, _7b, _7c) {
            ...
            $.ajax({
                type: _7d.method, url: _7d.url, data: _7a, dataType: "json", success: function (_7e) {
                    _7b(_7e);
                }, error: function () {
