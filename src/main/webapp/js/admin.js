            ...
            [{
                ...
                children:
                    [{
                        ...
                        state: "open",
                        iconCls: "icon-add-new",
                        url: "ActivityType/activityType_add.jsp"
                    },
                        {
                            text: "活动类型管理",
                            state: "open",
                            iconCls: "icon-manager",
                            url: "ActivityType/activityType_query_result.jsp"
                        }
                    ]
            }, {
                text: "公益活动管理",
                ...
                children:
                    [{
                        ...
                        state: "open",
                        iconCls: "icon-add-new",
                        url: "ActivityInfo/activityInfo_add.jsp"
                    },
                        {
                            text: "公益活动管理",
                            state: "open",
                            iconCls: "icon-manager",
                            url: "ActivityInfo/activityInfo_query_result.jsp"
                        }
                    ]
            }, {
                text: "活动报名管理",
                ...
                children:
                    [{
                        ...
                        state: "open",
                        iconCls: "icon-add-new",
                        url: "SignUp/signUp_add.jsp"
                    },
                        {
                            text: "活动报名管理",
                            state: "open",
                            iconCls: "icon-manager",
                            url: "SignUp/signUp_query_result.jsp"
                        }
                    ]
            }, {
                text: "捐款管理",
                ...
                children:
                    [{
                        ...
                        state: "open",
                        iconCls: "icon-add-new",
                        url: "Donation/donation_add.jsp"
                    },
                        {
                            text: "捐款管理",
                            state: "open",
                            iconCls: "icon-manager",
                            url: "Donation/donation_query_result.jsp"
                        }
                    ]
            }, {
                text: "留言管理",
