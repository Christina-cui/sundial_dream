...
(function ($) {
    ...
    function _11(_12, _13) {
        ...
        _18.css({
            paddingLeft: (_12.style.paddingLeft || ""),
            paddingRight: (_12.style.paddingRight || ""),
            marginLeft: _1e("left"),
            marginRight: _1e("right"),
            marginTop: _1c("top"),
            marginBottom: _1c("bottom")
        });
        if (_15.multiline) {
    ...
    $.fn.textbox = function (_3e, _3f) {
        ...
        return this.each(function () {
            ...
            if (_42) {
                ...
                _42 = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _3e),
                    textbox: _2(this)
                });
    ...
    $.fn.textbox.parseOptions = function (_65) {
        var t = $(_65);
        return $.extend({}, $.fn.validatebox.parseOptions(_65), $.parser.parseOptions(_65, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign", {
            multiline: "boolean",
            iconWidth: "number",
            labelWidth: "number"
